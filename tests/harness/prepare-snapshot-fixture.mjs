...
const {inspectWorkspace} = await import(pathToFileURL(path.join(plugin, 'lib/workspace/workspace.mjs')));
const {runPreparation, preparationStatus} = await import(pathToFileURL(path.join(plugin, 'lib/workspace/preparation.mjs')));
