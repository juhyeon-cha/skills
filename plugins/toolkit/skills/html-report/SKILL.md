...
`@font-face` 를 세 굵기에 372개 내주고, 원본 OTF 는 4.6MB 라 임베드 대상이
아니다. 위 조각은 **한글 2,350자(KS X 1001)만 든다 — 원본은 11,172자다**. 그 밖의
음절은 시스템 폰트로 떨어져 한 문장 안에서 서체가 갈린다. **본고딕을 고르면 이 한계를 말하고 그대로 갈지 확인한다.**
