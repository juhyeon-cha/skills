...
#
# **이 검사가 보지 않는 것** — 권한 deny 표면 · 플러그인 등재 표면 · git 훅 블록 대조 ·
# ../docs/guardrails.md 계수 대조 · "못 막는 것" rc=0 실측. 그 원본(settings.json · git 훅 ·
# 하네스 루트 문서)이 플러그인 트리 밖에 있어 이 검사의 사거리가 닿지 않는다.
#
