...
try {
  ...
  else throw new Error('usage: register <claude|codex> [absolute agents directory] | verify <registration.json> | call <registration.json> <request.json> | result <registration.json> <call.json> <outcome.json>');
