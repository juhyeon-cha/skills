...
Use transcript aggregates only when the session recorded a managed audit or a
usable historical capture. Ordinary delegation needs no inventory; use actual
findings and recorded outcomes instead, with measurement limits.
