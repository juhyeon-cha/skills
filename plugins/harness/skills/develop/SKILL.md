...
- **For cross-session independent evaluation recovery**, follow "Cross-session independent evaluator recovery" in `${CLAUDE_PLUGIN_ROOT}/docs/transcripts.md` for the supported scope, failure reference and capacity-wait procedure.
