...
- **Never judge completion by impression** — confirm the resulting state with relevant checks and acceptance comparison. `harness:verify-code` selects local or independent verification by risk.
