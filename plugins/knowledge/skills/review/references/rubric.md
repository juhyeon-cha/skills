...
- Uncertainty: do not treat unverified behavior or policy intent as proven. Missing source or
  configuration is unverified, not pass.

Give findings with the document path, claim ID and relevant source path. Judge within the supplied
scope and expose gaps; a narrow successful review does not certify complete knowledge coverage.
